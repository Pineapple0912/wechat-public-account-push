...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxe7e20768faa5ed4c',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'd7fedef6ed8246b384e252b0b6b2c01c',
   ...
   */
  USERS: [oQora6VtU9Pg7zPty63x5ZPyEYcM]
    {
      // 想要发送的人的名字
      name: '云宝',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oQora6VtU9Pg7zPty63x5ZPyEYcM',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '早上好呀 云宝',
      // 所在省份
      province: '福建',
      // 所在城市
      city: '福州',
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-09-07' },
      ],
      // 课程表相关配置
